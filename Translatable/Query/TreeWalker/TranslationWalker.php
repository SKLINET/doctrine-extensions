...
namespace SKLINET\DoctrineExtensionsBundle\Translatable\Query\TreeWalker;

use Doctrine\ORM\Mapping\ClassMetadata;
use SKLINET\DoctrineExtensionsBundle\Translatable\Mapping\Event\Adapter\ORM as TranslatableEventAdapter;
use SKLINET\DoctrineExtensionsBundle\Translatable\TranslatableListener;
    ...
    public function walkSelectStatement(SelectStatement $AST)
    {
        ...
        if ($hydrationMode === Query::HYDRATE_OBJECT) {
            ...
            $this->getEntityManager()->getConfiguration()->addCustomHydrationMode(
                ...
                'SKLINET\\DoctrineExtensionsBundle\\Translatable\\Hydrator\\ORM\\ObjectHydrator'
            );
            ...
            $this->getEntityManager()->getConfiguration()->addCustomHydrationMode(
                ...
                'SKLINET\\DoctrineExtensionsBundle\\Translatable\\Hydrator\\ORM\\SimpleObjectHydrator'
            );
            $this->getQuery()->setHint(Query::HINT_REFRESH, true);
        }
